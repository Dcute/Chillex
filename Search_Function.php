...
<div id="fh5co-container">
	...
	<div id="fh5co-menus" data-section="menu">
					...
					<ul>
						<?php
							...
							$user_search = $_GET['user_search'];
								...
								header('Location: More_Food_Menu.php');	
							}
							...
							$query = "SELECT * FROM dishes WHERE Dishes_Name LIKE '%" . $user_search . "%'";
							...
							// output data of each row
								...
								echo '<b><font size="6.8"> Dishes not Found ! </font size></b>';
							}
		...
		<div class="row">
			<div class="col-md-5 col-md-offset-4 text-left to-animate-2">
				<p>
				<a href="More_Food_Menu.php" class="btn btn-primary btn-outline">Back to Food Menu List</a>
				<a href="index.php" class="btn btn-primary btn-outline">Back to Home Page</a>
				</p>
			</div>
		</div>
		<br><br>
